...
export async function POST(request: Request){
    ...
    const response = await openai.createChatCompletion({
        ...
        messages: [
            {
                role: "system",
                content: `When responding, welcome the user as Mr.Dean and say welcome to Tasker! I am here to help you with your tasks. Limit the response to 200 characters.`,
            },
            {
                role: "user",
